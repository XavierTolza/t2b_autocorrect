...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "t2b.line_likelihood",
        "sources": [
            "t2b/line_likelihood.pyx"
        ]
    },
    "module_name": "t2b.line_likelihood"
}
END: Cython Metadata */
...
#define __PYX_HAVE__t2b__line_likelihood
#define __PYX_HAVE_API__t2b__line_likelihood
/* Early includes */
#include <stdint.h>
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 't2b.line_likelihood' */
...
static bool __pyx_f_3t2b_15line_likelihood_c_point_is_in_image(__pyx_t_5numpy_float64_t, __pyx_t_5numpy_float64_t, uint32_t, uint32_t); /*proto*/
static void __pyx_f_3t2b_15line_likelihood_c_line_find_coordinates(__pyx_t_5numpy_float64_t, __pyx_t_5numpy_float64_t, __Pyx_memviewslice, __pyx_t_5numpy_float64_t *); /*proto*/
static PyObject *__pyx_f_3t2b_15line_likelihood_line_find_coordinates(__pyx_t_5numpy_float64_t, __pyx_t_5numpy_float64_t, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static __pyx_t_5numpy_float64_t __pyx_f_3t2b_15line_likelihood_c_line_likelihood(__pyx_t_5numpy_float64_t, __pyx_t_5numpy_float64_t, __Pyx_memviewslice); /*proto*/
static void __pyx_f_3t2b_15line_likelihood_c_multi_line_likelihood(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static PyObject *__pyx_f_3t2b_15line_likelihood_line_likelihood(PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "t2b.line_likelihood"
extern int __pyx_module_is_main_t2b__line_likelihood;
int __pyx_module_is_main_t2b__line_likelihood = 0;

/* Implementation of 't2b.line_likelihood' */
...
static PyObject *__pyx_pf_3t2b_15line_likelihood_line_find_coordinates(CYTHON_UNUSED PyObject *__pyx_self, __pyx_t_5numpy_float64_t __pyx_v_angle, __pyx_t_5numpy_float64_t __pyx_v_radius, __Pyx_memviewslice __pyx_v_img); /* proto */
static PyObject *__pyx_pf_3t2b_15line_likelihood_2line_likelihood(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_angle, PyObject *__pyx_v_radius, PyObject *__pyx_v_img); /* proto */
...
static bool __pyx_f_3t2b_15line_likelihood_c_point_is_in_image(__pyx_t_5numpy_float64_t __pyx_v_x, __pyx_t_5numpy_float64_t __pyx_v_y, uint32_t __pyx_v_xmax, uint32_t __pyx_v_ymax) {
  bool __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;

  /* "t2b/line_likelihood.pyx":14
 * 
 * cdef bool c_point_is_in_image(np.float64_t x,np.float64_t y,uint32_t xmax,uint32_t ymax)nogil:
 *     if x<0 or y<0:             # <<<<<<<<<<<<<<
 *         return False
 ...
 *     return True
 */
  __pyx_t_2 = ((__pyx_v_x > __pyx_v_xmax) != 0);
  if (!__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
    goto __pyx_L7_bool_binop_done;
  }
  __pyx_t_2 = ((__pyx_v_y > __pyx_v_ymax) != 0);
  __pyx_t_1 = __pyx_t_2;
  __pyx_L7_bool_binop_done:;
  if (__pyx_t_1) {

    /* "t2b/line_likelihood.pyx":17
 *         return False
 *     if x>xmax or y>ymax:
 *         return False             # <<<<<<<<<<<<<<
 *     return True
...
static void __pyx_f_3t2b_15line_likelihood_c_line_find_coordinates(__pyx_t_5numpy_float64_t __pyx_v_angle, __pyx_t_5numpy_float64_t __pyx_v_radius, __Pyx_memviewslice __pyx_v_img, __pyx_t_5numpy_float64_t *__pyx_v_out) {
  ...
  __pyx_t_5numpy_float64_t __pyx_v_y2;
  __pyx_t_5numpy_float64_t __pyx_v_s;
  __pyx_t_5numpy_float64_t __pyx_v_c;
  __pyx_t_5numpy_float64_t *__pyx_v_intersection;
  uint32_t __pyx_v_i;
  uint32_t __pyx_v_j;
  __pyx_t_5numpy_float64_t __pyx_t_1[8];
  int __pyx_t_2;
  __pyx_t_5numpy_float64_t __pyx_t_3;
  uint32_t __pyx_t_4;
  uint32_t __pyx_t_5;

  /* "t2b/line_likelihood.pyx":21
 * 
 * cdef void c_line_find_coordinates(np.float64_t angle,np.float64_t radius, np.float64_t[:,:] img, np.float64_t* out)nogil:
 *     cdef uint32_t xmax = img.shape[0]             # <<<<<<<<<<<<<<
 *     cdef uint32_t ymax = img.shape[1]
 ...
 */
    ...
    (__pyx_v_intersection[2]) = (__pyx_v_radius / __pyx_v_c);

    /* "t2b/line_likelihood.pyx":29
 *     if c!=0:
 *         intersection[2] = radius/c
 *         intersection[3] = 0             # <<<<<<<<<<<<<<
 *         intersection[6] = (radius-ymax*s)/c
 *         intersection[7] = ymax
 */
    (__pyx_v_intersection[3]) = 0.0;

    /* "t2b/line_likelihood.pyx":30
 *         intersection[2] = radius/c
 *         intersection[3] = 0
 *         intersection[6] = (radius-ymax*s)/c             # <<<<<<<<<<<<<<
 *         intersection[7] = ymax
 *     if s!=0:
 */
    __pyx_t_3 = (__pyx_v_radius - (__pyx_v_ymax * __pyx_v_s));
    if (unlikely(__pyx_v_c == 0)) {
      #ifdef WITH_THREAD
      PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
      #endif
    ...
    (__pyx_v_intersection[6]) = (__pyx_t_3 / __pyx_v_c);

    /* "t2b/line_likelihood.pyx":31
 *         intersection[3] = 0
 *         intersection[6] = (radius-ymax*s)/c
 *         intersection[7] = ymax             # <<<<<<<<<<<<<<
 *     if s!=0:
 *         intersection[0] = 0
 */
    (__pyx_v_intersection[7]) = __pyx_v_ymax;
 ...
 *         intersection[4] = xmax
 */
    (__pyx_v_intersection[0]) = 0.0;

    /* "t2b/line_likelihood.pyx":34
 *     if s!=0:
 *         intersection[0] = 0
 *         intersection[1] = radius/s             # <<<<<<<<<<<<<<
 *         intersection[4] = xmax
 ...
 */
    ...
    (__pyx_v_intersection[1]) = (__pyx_v_radius / __pyx_v_s);

    /* "t2b/line_likelihood.pyx":35
 *         intersection[0] = 0
 *         intersection[1] = radius/s
 *         intersection[4] = xmax             # <<<<<<<<<<<<<<
 *         intersection[5] = (radius-xmax*c)/s
 *     cdef uint32_t i,j,k
 */
    (__pyx_v_intersection[4]) = __pyx_v_xmax;

    /* "t2b/line_likelihood.pyx":36
 *         intersection[1] = radius/s
 *         intersection[4] = xmax
 *         intersection[5] = (radius-xmax*c)/s             # <<<<<<<<<<<<<<
 *     cdef uint32_t i,j,k
 * 
 */
    __pyx_t_3 = (__pyx_v_radius - (__pyx_v_xmax * __pyx_v_c));
    if (unlikely(__pyx_v_s == 0)) {
      #ifdef WITH_THREAD
      PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
      #endif
    ...
    (__pyx_v_intersection[5]) = (__pyx_t_3 / __pyx_v_s);
 ...
 */
    __pyx_v_x1 = (__pyx_v_intersection[(__pyx_v_i * 2)]);

    /* "t2b/line_likelihood.pyx":41
 *     for i in range(4):
 *         x1 = intersection[i*2]
 *         y1 = intersection[i*2+1]             # <<<<<<<<<<<<<<
 *         if c_point_is_in_image(x1,y1,xmax,ymax):
 *             for j in range(4):
 */
    __pyx_v_y1 = (__pyx_v_intersection[((__pyx_v_i * 2) + 1)]);

    /* "t2b/line_likelihood.pyx":42
 *         x1 = intersection[i*2]
 *         y1 = intersection[i*2+1]
 *         if c_point_is_in_image(x1,y1,xmax,ymax):             # <<<<<<<<<<<<<<
 *             for j in range(4):
 *                 if j!=i:
 */
    __pyx_t_2 = (__pyx_f_3t2b_15line_likelihood_c_point_is_in_image(__pyx_v_x1, __pyx_v_y1, __pyx_v_xmax, __pyx_v_ymax) != 0);
    if (__pyx_t_2) {

      /* "t2b/line_likelihood.pyx":43
 *         y1 = intersection[i*2+1]
 *         if c_point_is_in_image(x1,y1,xmax,ymax):
 *             for j in range(4):             # <<<<<<<<<<<<<<
 *                 if j!=i:
 ...
 */
          __pyx_v_x2 = (__pyx_v_intersection[(__pyx_v_j * 2)]);

          /* "t2b/line_likelihood.pyx":46
 *                 if j!=i:
 *                     x2 = intersection[j*2]
 *                     y2 = intersection[j*2+1]             # <<<<<<<<<<<<<<
 *                     if c_point_is_in_image(x2,y2,xmax,ymax):
 *                         out[0] = x1
 */
          __pyx_v_y2 = (__pyx_v_intersection[((__pyx_v_j * 2) + 1)]);

          /* "t2b/line_likelihood.pyx":47
 *                     x2 = intersection[j*2]
 *                     y2 = intersection[j*2+1]
 *                     if c_point_is_in_image(x2,y2,xmax,ymax):             # <<<<<<<<<<<<<<
 *                         out[0] = x1
 *                         out[1] = y1
 */
          __pyx_t_2 = (__pyx_f_3t2b_15line_likelihood_c_point_is_in_image(__pyx_v_x2, __pyx_v_y2, __pyx_v_xmax, __pyx_v_ymax) != 0);
          if (__pyx_t_2) {

            /* "t2b/line_likelihood.pyx":48
 *                     y2 = intersection[j*2+1]
 *                     if c_point_is_in_image(x2,y2,xmax,ymax):
 *                         out[0] = x1             # <<<<<<<<<<<<<<
 *                         out[1] = y1
 *                         out[2] = x2
 */
            (__pyx_v_out[0]) = __pyx_v_x1;

            /* "t2b/line_likelihood.pyx":49
 *                     if c_point_is_in_image(x2,y2,xmax,ymax):
 *                         out[0] = x1
 *                         out[1] = y1             # <<<<<<<<<<<<<<
 *                         out[2] = x2
 *                         out[3] = y2
 */
            (__pyx_v_out[1]) = __pyx_v_y1;

            /* "t2b/line_likelihood.pyx":50
 *                         out[0] = x1
 *                         out[1] = y1
 *                         out[2] = x2             # <<<<<<<<<<<<<<
 *                         out[3] = y2
 *                         return
 */
            (__pyx_v_out[2]) = __pyx_v_x2;

            /* "t2b/line_likelihood.pyx":51
 *                         out[1] = y1
 *                         out[2] = x2
 *                         out[3] = y2             # <<<<<<<<<<<<<<
 *                         return
 * 
 */
            (__pyx_v_out[3]) = __pyx_v_y2;

            /* "t2b/line_likelihood.pyx":52
 *                         out[2] = x2
 *                         out[3] = y2
 *                         return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("t2b.line_likelihood.c_line_find_coordinates", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "t2b/line_likelihood.pyx":54
 *                         return
 * 
 * cpdef line_find_coordinates(np.float64_t angle,np.float64_t radius, np.float64_t[:,:] img):             # <<<<<<<<<<<<<<
 *     res=pnp.zeros(4)
...
static PyObject *__pyx_pw_3t2b_15line_likelihood_1line_find_coordinates(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_3t2b_15line_likelihood_line_find_coordinates(__pyx_t_5numpy_float64_t __pyx_v_angle, __pyx_t_5numpy_float64_t __pyx_v_radius, __Pyx_memviewslice __pyx_v_img, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_v_res = NULL;
  __Pyx_memviewslice __pyx_v_tmp = { 0, 0, { 0 }, { 0 }, { 0 } };
  __pyx_t_5numpy_float64_t *__pyx_v__res;
  ...
  int __pyx_t_6;
  __Pyx_RefNannySetupContext("line_find_coordinates", 0);

  /* "t2b/line_likelihood.pyx":55
 * 
 * cpdef line_find_coordinates(np.float64_t angle,np.float64_t radius, np.float64_t[:,:] img):
 *     res=pnp.zeros(4)             # <<<<<<<<<<<<<<
 *     cdef np.float64_t[:] tmp = res
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_pnp); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 55, __pyx_L1_error)
 ...
 */
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(__pyx_v_res, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 56, __pyx_L1_error)
  __pyx_v_tmp = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "t2b/line_likelihood.pyx":57
 *     res=pnp.zeros(4)
 *     cdef np.float64_t[:] tmp = res
 *     cdef np.float64_t* _res = &tmp[0]             # <<<<<<<<<<<<<<
 *     c_line_find_coordinates(angle,radius,img,_res)
 ...
 */
  ...
  __pyx_t_6 = -1;
  if (__pyx_t_5 < 0) {
    __pyx_t_5 += __pyx_v_tmp.shape[0];
    if (unlikely(__pyx_t_5 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_5 >= __pyx_v_tmp.shape[0])) __pyx_t_6 = 0;
  if (unlikely(__pyx_t_6 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_6);
    __PYX_ERR(0, 57, __pyx_L1_error)
  }
  __pyx_v__res = (&(*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_tmp.data + __pyx_t_5 * __pyx_v_tmp.strides[0]) ))));

  /* "t2b/line_likelihood.pyx":58
 *     cdef np.float64_t[:] tmp = res
 *     cdef np.float64_t* _res = &tmp[0]
 *     c_line_find_coordinates(angle,radius,img,_res)             # <<<<<<<<<<<<<<
 *     return res
 * 
 */
  __pyx_f_3t2b_15line_likelihood_c_line_find_coordinates(__pyx_v_angle, __pyx_v_radius, __pyx_v_img, __pyx_v__res);

  /* "t2b/line_likelihood.pyx":59
 *     cdef np.float64_t* _res = &tmp[0]
 *     c_line_find_coordinates(angle,radius,img,_res)
 *     return res             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("t2b.line_likelihood.line_find_coordinates", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_3t2b_15line_likelihood_1line_find_coordinates(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_3t2b_15line_likelihood_1line_find_coordinates(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __pyx_t_5numpy_float64_t __pyx_v_angle;
  __pyx_t_5numpy_float64_t __pyx_v_radius;
  __Pyx_memviewslice __pyx_v_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("line_find_coordinates (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_angle,&__pyx_n_s_radius,&__pyx_n_s_img,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_radius)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("line_find_coordinates", 1, 3, 3, 1); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_img)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("line_find_coordinates", 1, 3, 3, 2); __PYX_ERR(0, 54, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "line_find_coordinates") < 0)) __PYX_ERR(0, 54, __pyx_L3_error)
      }
    ...
    __pyx_v_angle = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_angle == ((npy_float64)-1)) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_radius = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_radius == ((npy_float64)-1)) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_img = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_float64_t(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_img.memview)) __PYX_ERR(0, 54, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("line_find_coordinates", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 54, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("t2b.line_likelihood.line_find_coordinates", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3t2b_15line_likelihood_line_find_coordinates(__pyx_self, __pyx_v_angle, __pyx_v_radius, __pyx_v_img);
...
static PyObject *__pyx_pf_3t2b_15line_likelihood_line_find_coordinates(CYTHON_UNUSED PyObject *__pyx_self, __pyx_t_5numpy_float64_t __pyx_v_angle, __pyx_t_5numpy_float64_t __pyx_v_radius, __Pyx_memviewslice __pyx_v_img) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("line_find_coordinates", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_img.memview)) { __Pyx_RaiseUnboundLocalError("img"); __PYX_ERR(0, 54, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_3t2b_15line_likelihood_line_find_coordinates(__pyx_v_angle, __pyx_v_radius, __pyx_v_img, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static __pyx_t_5numpy_float64_t __pyx_f_3t2b_15line_likelihood_c_line_likelihood(__pyx_t_5numpy_float64_t __pyx_v_angle, __pyx_t_5numpy_float64_t __pyx_v_radius, __Pyx_memviewslice __pyx_v_img) {
 ...
 */
  __pyx_f_3t2b_15line_likelihood_c_line_find_coordinates(__pyx_v_angle, __pyx_v_radius, __pyx_v_img, __pyx_v_coord);

  /* "t2b/line_likelihood.pyx":67
 *     cdef np.float64_t x1,y1,x2,y2,ratio
 *     cdef uint32_t distance,x,y
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("t2b.line_likelihood.c_line_likelihood", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}

/* "t2b/line_likelihood.pyx":86
 *     return 0
 * 
 * cdef void c_multi_line_likelihood(np.float64_t[:] angle,np.float64_t[:] radius, np.float64_t[:,:] img, np.float64_t[:] out)nogil:             # <<<<<<<<<<<<<<
...
static void __pyx_f_3t2b_15line_likelihood_c_multi_line_likelihood(__Pyx_memviewslice __pyx_v_angle, __Pyx_memviewslice __pyx_v_radius, __Pyx_memviewslice __pyx_v_img, __Pyx_memviewslice __pyx_v_out) {
  CYTHON_UNUSED uint32_t __pyx_v_total;
  uint32_t __pyx_v_i;
  uint32_t __pyx_t_1;
  uint32_t __pyx_t_2;
  uint32_t __pyx_t_3;
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if ((1 == 0)) abort();
        {
            uint32_t __pyx_parallel_temp0 = ((uint32_t)0xbad0bad0);
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_4, __pyx_t_5, __pyx_t_6, __pyx_t_7) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #ifdef WITH_THREAD
 ...
 */
                            ...
                            *((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_out.data + __pyx_t_7 * __pyx_v_out.strides[0]) )) = __pyx_f_3t2b_15line_likelihood_c_line_likelihood((*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_angle.data + __pyx_t_4 * __pyx_v_angle.strides[0]) ))), (*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_radius.data + __pyx_t_6 * __pyx_v_radius.strides[0]) ))), __pyx_v_img);
                            goto __pyx_L11;
                            __pyx_L8_error:;
                            {
                                #ifdef WITH_THREAD
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("t2b.line_likelihood.c_multi_line_likelihood", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "t2b/line_likelihood.pyx":94
 *         out[i] = c_line_likelihood(angle[i],radius[i],img)
 * 
 * cpdef line_likelihood(angle,radius,img):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_3t2b_15line_likelihood_3line_likelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_3t2b_15line_likelihood_line_likelihood(PyObject *__pyx_v_angle, PyObject *__pyx_v_radius, PyObject *__pyx_v_img, CYTHON_UNUSED int __pyx_skip_dispatch) {
  uint32_t __pyx_v_total;
  PyObject *__pyx_v_res = NULL;
  __Pyx_memviewslice __pyx_v__res = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v__img = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v__a = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v__b = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  uint32_t __pyx_t_2;
  ...
  __Pyx_RefNannySetupContext("line_likelihood", 0);

  /* "t2b/line_likelihood.pyx":95
 * 
 * cpdef line_likelihood(angle,radius,img):
 *     cdef uint32_t total = angle.size             # <<<<<<<<<<<<<<
 *     assert total == radius.size
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_angle, __pyx_n_s_size); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_As_uint32_t(__pyx_t_1); if (unlikely((__pyx_t_2 == ((uint32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_total = __pyx_t_2;

  /* "t2b/line_likelihood.pyx":96
 * cpdef line_likelihood(angle,radius,img):
 *     cdef uint32_t total = angle.size
 *     assert total == radius.size             # <<<<<<<<<<<<<<
 *     res = pnp.zeros(total,dtype=pnp.float64)
 ...
 */
  ...
  if (unlikely(!Py_OptimizeFlag)) {
    __pyx_t_1 = __Pyx_PyInt_From_uint32_t(__pyx_v_total); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 96, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_radius, __pyx_n_s_size); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 96, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyObject_RichCompare(__pyx_t_1, __pyx_t_3, Py_EQ); __Pyx_XGOTREF(__pyx_t_4); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 96, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_pnp); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_From_uint32_t(__pyx_v_total); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_GetModuleGlobalName(__pyx_t_6, __pyx_n_s_pnp); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_float64); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_7) < 0) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_1, __pyx_t_4); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(__pyx_v_res, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 98, __pyx_L1_error)
  __pyx_v__res = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "t2b/line_likelihood.pyx":99
 *     res = pnp.zeros(total,dtype=pnp.float64)
 *     cdef np.float64_t[:] _res=res
 *     cdef np.float64_t[:,:] _img = img.astype(pnp.float64)             # <<<<<<<<<<<<<<
 *     cdef np.float64_t [::1] _a = angle.astype(pnp.float64)
 ...
 */
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_img, __pyx_n_s_astype); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 99, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_pnp); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 99, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_float64_t(__pyx_t_7, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 99, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_v__img = __pyx_t_9;
  __pyx_t_9.memview = NULL;
  __pyx_t_9.data = NULL;

  /* "t2b/line_likelihood.pyx":100
 *     cdef np.float64_t[:] _res=res
 *     cdef np.float64_t[:,:] _img = img.astype(pnp.float64)
 *     cdef np.float64_t [::1] _a = angle.astype(pnp.float64)             # <<<<<<<<<<<<<<
 *     cdef np.float64_t [::1] _b = radius.astype(pnp.float64)
 *     cdef uint32_t i
 */
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_angle, __pyx_n_s_astype); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 100, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_pnp); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 100, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_float64); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 100, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_4))) {
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5numpy_float64_t(__pyx_t_7, PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 100, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_v__a = __pyx_t_10;
  __pyx_t_10.memview = NULL;
  __pyx_t_10.data = NULL;

  /* "t2b/line_likelihood.pyx":101
 *     cdef np.float64_t[:,:] _img = img.astype(pnp.float64)
 *     cdef np.float64_t [::1] _a = angle.astype(pnp.float64)
 *     cdef np.float64_t [::1] _b = radius.astype(pnp.float64)             # <<<<<<<<<<<<<<
 *     cdef uint32_t i
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_radius, __pyx_n_s_astype); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 101, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_pnp); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 101, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_float64); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 101, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_4))) {
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5numpy_float64_t(__pyx_t_7, PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 101, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_v__b = __pyx_t_10;
  __pyx_t_10.memview = NULL;
  __pyx_t_10.data = NULL;

  /* "t2b/line_likelihood.pyx":104
 *     cdef uint32_t i
 * 
 *     c_multi_line_likelihood(_a,_b,_img,_res)             # <<<<<<<<<<<<<<
 *     return res
 */
  __pyx_f_3t2b_15line_likelihood_c_multi_line_likelihood(__pyx_v__a, __pyx_v__b, __pyx_v__img, __pyx_v__res);

  /* "t2b/line_likelihood.pyx":105
 * 
 *     c_multi_line_likelihood(_a,_b,_img,_res)
 *     return res             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("t2b.line_likelihood.line_likelihood", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_res);
  __PYX_XDEC_MEMVIEW(&__pyx_v__res, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v__img, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v__a, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v__b, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_3t2b_15line_likelihood_3line_likelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_3t2b_15line_likelihood_3line_likelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_angle = 0;
  PyObject *__pyx_v_radius = 0;
  PyObject *__pyx_v_img = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("line_likelihood (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_angle,&__pyx_n_s_radius,&__pyx_n_s_img,0};
    PyObject* values[3] = {0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_radius)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("line_likelihood", 1, 3, 3, 1); __PYX_ERR(0, 94, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_img)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("line_likelihood", 1, 3, 3, 2); __PYX_ERR(0, 94, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "line_likelihood") < 0)) __PYX_ERR(0, 94, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("line_likelihood", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 94, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("t2b.line_likelihood.line_likelihood", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3t2b_15line_likelihood_2line_likelihood(__pyx_self, __pyx_v_angle, __pyx_v_radius, __pyx_v_img);
...
static PyObject *__pyx_pf_3t2b_15line_likelihood_2line_likelihood(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_angle, PyObject *__pyx_v_radius, PyObject *__pyx_v_img) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("line_likelihood", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_3t2b_15line_likelihood_line_likelihood(__pyx_v_angle, __pyx_v_radius, __pyx_v_img, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "t2b.line_likelihood.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "t2b.line_likelihood.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "t2b.line_likelihood.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "t2b.line_likelihood._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"line_find_coordinates", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3t2b_15line_likelihood_1line_find_coordinates, METH_VARARGS|METH_KEYWORDS, 0},
  {"line_likelihood", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3t2b_15line_likelihood_3line_likelihood, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_line_likelihood(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_line_likelihood},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initline_likelihood(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initline_likelihood(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_line_likelihood(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_line_likelihood(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_line_likelihood(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'line_likelihood' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_line_likelihood(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("line_likelihood", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_t2b__line_likelihood) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "t2b.line_likelihood")) {
      if (unlikely(PyDict_SetItemString(modules, "t2b.line_likelihood", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init t2b.line_likelihood", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init t2b.line_likelihood");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
